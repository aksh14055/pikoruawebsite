...
export const PROPERTY_TYPE_KEYWORD_CLUSTERS = {
  ...
  "luxury-property-ahmedabad": {
    pillar: "Luxury property in Ahmedabad across apartments, penthouses, villas, bungalows, plots, and investment assets",
    primary: [
      "luxury property Ahmedabad",
      "premium property Ahmedabad",
      "luxury homes Ahmedabad",
      "luxury residential property Ahmedabad",
      "exclusive properties Ahmedabad",
    ],
    transactional: [
      "buy luxury property in Ahmedabad",
      "luxury property for sale Ahmedabad",
      "premium property for sale Ahmedabad",
      "private luxury property search Ahmedabad",
    ...
    longTail: [
      "best luxury property in Ahmedabad for families",
      "rare luxury homes in western Ahmedabad",
      "verified luxury property shortlist Ahmedabad",
      "luxury property with high resale value Ahmedabad",
      "premium residential property with legal clarity Ahmedabad",
      "luxury property near clubs and schools Ahmedabad",
      "large luxury homes for HNI families Ahmedabad",
      "confidential luxury property transactions Ahmedabad",
    ],
    nri: [
      "NRI luxury property Ahmedabad",
      "NRI property investment Ahmedabad",
      "buy property in Ahmedabad from abroad",
      "Ahmedabad luxury homes for NRIs",
      "remote luxury property purchase Ahmedabad",
    ],
    hni: [
      "HNI luxury property Ahmedabad",
      "HNI property consultant Ahmedabad",
      "private real estate advisory for HNIs Ahmedabad",
      "family office property advisory Ahmedabad",
    ],
    locationModifiers: [...WESTERN_CORRIDORS],
    attributeModifiers: [
      "verified title",
    ...
    questions: [
      "which is the best luxury property in Ahmedabad",
      "where should NRIs buy luxury property in Ahmedabad",
      "how do I find off market luxury property in Ahmedabad",
      "what documents are needed to buy luxury property in Ahmedabad",
    ],
    comparisons: [
      "Ahmedabad luxury property vs Mumbai luxury property",
      "luxury apartment vs villa Ahmedabad",
      "Iscon Ambli vs Sindhu Bhavan luxury property",
    ],
    contentAngles: [
      "Ahmedabad luxury property buying framework",
      "Luxury property due diligence for HNI and NRI buyers",
      "How PIKORUA filters private luxury property inventory",
    ],
  },
  ...
  "luxury-real-estate-consultants-ahmedabad": {
    pillar: "Luxury real estate consultants in Ahmedabad for HNIs and NRIs",
    primary: [
      "luxury real estate consultants Ahmedabad",
      "luxury real estate consultant Ahmedabad",
      "HNI property consultant Ahmedabad",
    ...
    transactional: [
      "hire luxury real estate consultant Ahmedabad",
      "best luxury real estate consultant Ahmedabad",
      "trusted luxury real estate consultants Ahmedabad",
      "luxury property advisor Ahmedabad",
      "private property consultant Ahmedabad",
      "exclusive real estate consultant Ahmedabad",
    ],
    longTail: [
      "luxury real estate consultants in Ahmedabad for HNIs and NRIs",
      "consultant for off market luxury homes Ahmedabad",
      "luxury home buying consultant Ahmedabad",
      "luxury property shortlisting service Ahmedabad",
      "private real estate consultant for family buyers Ahmedabad",
      "developer verification consultant Ahmedabad",
      "documentation support luxury property Ahmedabad",
    ],
    nri: [
      "NRI real estate consultant Ahmedabad",
      "NRI property advisor Ahmedabad",
      "remote property consultant Ahmedabad",
      "NRI luxury home buying consultant Ahmedabad",
      "NRI documentation support Ahmedabad property",
    ],
    hni: [
      "HNI real estate consultant Ahmedabad",
      "HNI luxury property advisor Ahmedabad",
      "private advisory for HNI buyers Ahmedabad",
      "confidential property consultant Ahmedabad",
    ],
    locationModifiers: [...WESTERN_CORRIDORS],
    attributeModifiers: [...ADVISORY_MODIFIERS],
    questions: [
      "who are the best luxury real estate consultants in Ahmedabad",
      "why use a luxury property consultant instead of a portal",
      "how can NRIs buy property in Ahmedabad remotely",
      "what does a luxury real estate consultant do",
    ],
    comparisons: [
      "luxury real estate consultant vs broker Ahmedabad",
      "property portal vs private advisory Ahmedabad",
      "buyer representation vs seller mandate Ahmedabad",
    ],
    contentAngles: [
      "How to choose a luxury real estate consultant in Ahmedabad",
      "Private advisory model for HNI and NRI buyers",
      "Why consultant-led shortlisting reduces luxury property risk",
    ],
  },
  "luxury-property-consultant-ahmedabad": {
