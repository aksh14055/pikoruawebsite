...
export const PROPERTY_TYPE_KEYWORD_CLUSTERS = {
  "luxury-apartments-ahmedabad": {
    ...
    nri: [
      ...
      "luxury condominium Ahmedabad",
      "condo for sale in Ahmedabad",
      "gated condo community Ahmedabad",
      "high rise condominium Ahmedabad",
      "NRI condo investment India",
      "sky villa Ahmedabad",
      "private lift lobby condo Ahmedabad",
      "low density luxury condo Ahmedabad",
    ],
    hni: [
  ...
  "luxury-villas-ahmedabad": {
    ...
    nri: [
      ...
      "townhouse for sale Ahmedabad",
      "luxury townhome Ahmedabad",
      "gated townhouse community Ahmedabad",
      "freehold estate Ahmedabad NRI",
      "row house for sale Ahmedabad",
    ],
    hni: [
      "HNI villa Ahmedabad",
