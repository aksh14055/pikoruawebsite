// Fallback About page content, used when the Supabase "pages" singleton
// (id: "about", managed via /admin) has no content yet. Shared between
...
export const DEFAULT_FOUNDER_STORY: string[] = [
  ...
  "With deep experience in prime areas like Sindhu Bhavan Road and Iskon-Ambli, Jitendra and his team advise business leaders, public figures, NRIs and discerning families seeking homes that reflect their lifestyle and aspirations. At PIKORUA Realty, luxury isn't just where you live — it's how you feel when you arrive home.",
];
