  ...
  "@graph": [
    ...
    },
    {
      ...
      knowsAbout: [
        ...
        "Real estate broker Ahmedabad",
        "Property consultant Gujarat",
        "Real estate advisory Ahmedabad",
        "Property dealers in Ahmedabad",
        "Real estate consultancies in Ahmedabad",
        "Best real estate agent in Ahmedabad",
        // Core high-intent luxury
        ...
        "Luxury real estate agent Ahmedabad",
        "Trusted luxury property consultant Ahmedabad",
        "Best luxury property broker in Ahmedabad",
        "NRI property consultant Ahmedabad",
        "Luxury real estate consultancy Ahmedabad",
        "Luxury property channel partner Ahmedabad",
        "Luxury property brokers Ahmedabad",
        // Authority & trust
        "Best property consultant in Ahmedabad",
        "Best real estate broker in Ahmedabad",
        "Trusted property dealer Ahmedabad",
        "Best luxury real estate consultant Ahmedabad",
        "Ahmedabad luxury property expert",
        "Experienced luxury property consultant",
        // Property types
        "Luxury apartments in Ahmedabad",
        "Luxury 4 BHK in Ahmedabad",
        "Luxury 5 BHK in Ahmedabad",
        "Premium penthouse in Ahmedabad",
        "Luxury duplex in Ahmedabad",
        "Luxury bungalow in Ahmedabad",
        "Luxury villa in Ahmedabad",
        "Villas in Ahmedabad",
        "Bungalows in Ahmedabad",
        "Penthouses in Ahmedabad",
        "Luxury plot for sale in Ahmedabad",
        "Plots in Ahmedabad",
        "Premium commercial property in Ahmedabad",
        "Luxury office space in Ahmedabad",
        "Weekend villa near Ahmedabad",
        // Location
        "Luxury property in Sindhu Bhavan Road",
        "Luxury property in Iskon Ambli Road",
        "Luxury property on SG Highway",
        "Luxury property in Thaltej",
        "Luxury property in Vastrapur",
        "Luxury property near Rajpath Club",
        "Luxury property near Karnavati Club",
        "Luxury property near Nehru Nagar",
        "Luxury property near Zydus Hospital",
        "Luxury property near Palladium Mall",
        "Luxury property near Ahmedabad Airport",
        // NRI & investment
